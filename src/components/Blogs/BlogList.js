...
import { FaArrowLeft, FaComments, FaEdit, FaTrash, FaSearch } from 'react-icons/fa';
    ...
    return (
      <div className="max-w-4xl mx-auto p-6 bg-white shadow-xl rounded-lg mt-8">
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          <button className="flex items-center px-4 py-2 bg-blue-600 text-white font-bold rounded-md shadow-md hover:bg-blue-700 transition duration-300">
            <FaEdit className="mr-2" /> Edit Blog
          </button>
          <button className="flex items-center px-4 py-2 bg-red-600 text-white font-bold rounded-md shadow-md hover:bg-red-700 transition duration-300">
